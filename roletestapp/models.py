...
class ChildModel(AccessControlledModelMixin, models.Model):
    ...
    role_conditions = {
        AccessRole.REPORTER: models.Q(author='cur_user'),
    }
    role_permissions = {
        ...
        'test': [
            ...
            (AccessRole.SUPERUSER | AccessRole.MODERATOR | AccessRole.REPORTER, models.Q(visibility=2)),
            (AccessRole.SUPERUSER | AccessRole.MODERATOR | AccessRole.REPORTER | AccessRole.PUBLIC, models.Q(visibility=3)),
        ]
    }

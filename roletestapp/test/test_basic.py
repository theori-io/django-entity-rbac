...
class TestBasicRoleFetch(TestCase):
    ...
    def setUp(self):
        ...
        self.child_roles[self.child_bar.pk][self.user_carol.pk] |= AccessRole.REPORTER
        ...
        self.child_roles[self.child_baz.pk][self.user_alice.pk] |= AccessRole.REPORTER
        ...
        self.child_roles[self.child_qux.pk][self.user_alice.pk] |= AccessRole.REPORTER
    ...
    def test_filter_roles(self):
        ...
        rolelist.append(rolelist[-1] | AccessRole.REPORTER)
